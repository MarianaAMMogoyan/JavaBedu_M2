...
public class GestionOrdenes {
    ...
    public static void main(String[] args) {
        ...
        List<OrdenMasa> masas = Arrays.asList(
                new OrdenMasa("ABC-123", 800),
                new OrdenMasa("DEF-456", 350)
        );

        List<OrdenPersonalizada> personalizadas = Arrays.asList(
                new OrdenPersonalizada("P123", 200, "Mariana"),
                new OrdenPersonalizada("P111", 150, "Alejandra")
        );

        List<OrdenPrototipo> prototipos = Arrays.asList(
                new OrdenPrototipo("T246", 7, "Diseño"),
                new OrdenPrototipo("T891", 3, "Pruebas")
        );
